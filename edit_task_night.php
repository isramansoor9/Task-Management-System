...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if ($stmt) {
        ...
        $stmt->execute();
        $stmt->close();
        header("Location: night_mode.php"); // Redirect back to task list
        exit;
    } else {
    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <input style="background-color: gray" type="text" class="form-control" id="task" name="task" value="<?php echo $task; ?>">
            </div>
